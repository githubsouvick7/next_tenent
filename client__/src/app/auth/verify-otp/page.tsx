    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-4 w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 text-center mt-2">
            <p className="text-gray-600 text-center mt-2">
              ...
              {localStorage.getItem("email")}.<br /> Please enter the code below
        ...
        <Button
          ...
          className="w-full bg-indigo-600 text-white rounded-lg py-4 font-semibold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          {isVerifying ? (
        ...
        <div className="mt-6 flex flex-col items-center gap-2 text-center text-sm">
          ...
          <div className="text-gray-600 text-sm">
            ...
            <Link
              className="text-indigo-600 font-semibold hover:text-indigo-700 focus:outline-none text-sm"
              href="/auth"
            >
              Change Email
            </Link>
